...
interface CapabilitySessionPageProps {
  params: Promise<{ plantId: string }>
  searchParams: Promise<{ id?: string | string[] }>
}

export default async function CapabilitySessionPage({ params, searchParams }: CapabilitySessionPageProps) {
  ...
  const screen = await renderCapabilityScreen(capability.data.type, 'session', {
    plantId,
