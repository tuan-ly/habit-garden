...
export type GardenMode = 'interact' | 'edit'
...
/**
 * Single toggle button for Edit mode.
 * - Default (interact): Click plant → watering modal
 * - Edit mode: Add plants, move plants around
 */
