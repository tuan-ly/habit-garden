-- Phase 04: Atomic economy operations (craft, purchase, pickup)
-- All-or-nothing semantics in single transactions to prevent partial state.

-- Allow 'pickup' as a valid acquired_via value
...
-- =====================================================
-- craft_decoration: deduct materials + award decoration atomically
-- =====================================================
...
-- =====================================================
-- purchase_decoration: spend coins + award decoration atomically
-- =====================================================
...
-- =====================================================
-- pickup_decoration: remove from world + add to inventory atomically
-- =====================================================
